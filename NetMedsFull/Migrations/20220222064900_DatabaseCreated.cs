    ...
    public partial class DatabaseCreated : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ProductFactories", x => x.Id);
                    table.ForeignKey(
                        name: "FK_ProductFactories_Manufactories_ManufactoryId",
                        column: x => x.ManufactoryId,
                        principalTable: "Manufactories",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_ProductFactories_Products_ProductId",
                        column: x => x.ProductId,
                        principalTable: "Products",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ProductFactories_ManufactoryId",
                table: "ProductFactories",
                column: "ManufactoryId");

            migrationBuilder.CreateIndex(
                name: "IX_ProductFactories_ProductId",
                table: "ProductFactories",
                column: "ProductId");
